...
import { getTodayDateString, isTodayOrFutureDate, isValidPhoneNumber } from "../../utils/formValidation";
  ...
  return (
    <div className="rounded-xl border border-amber-500/20 bg-[#111] p-6 sm:p-9">
      ...
      <div className="space-y-5">
        ...
        <input type="date" name="date" min={today} value={formData.date} onChange={handleChange} className="form-input" />
